...
<head>
    ...
    <title>Web Devlopment exam</title>
...
?>
	<div id="page-wrap">
		...
		<h1>Simple Quiz  On web Devlopment</h1><br>
...
echo '<form action="result.php" method="post" >
		 ...
		 <li>
                ...
                <li>
                    ...
                    <div>
                        <input type="radio" name="question-5-answers" id="question-5-answers-A" value="A" />
                        <label for="question-5-answers-A">A) Hight Tools Markup Language </label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-5-answers" id="question-5-answers-B" value="B" />
                        <label for="question-5-answers-B">B) Hyper tools Markup Language </label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-5-answers" id="question-5-answers-C" value="C" />
                        <label for="question-5-answers-C">C) Hyper Markup Language </label>
                    </div>
