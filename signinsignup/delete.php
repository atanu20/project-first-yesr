...
<div class="card text-center ">
  <div class="card-header"><span><h3 class="font-weight-bold">For Delete Search Here</h3></span></div>
...
<img src="dataimage/<?php echo $row['Image'];?>" style="width:150px;height:150px;">
    ...
    <button type="submit" name="delete" class="btn btn-success" onclick=" return del()">Delete</button>
  </form>
...
$qq="DELETE FROM `login` WHERE id='$_POST[id]' ";
